...
<Playground>
  <Box padding="xs" style={{ width: '300px' }}>
    <Stack>
      <TextField label="Small with" size="s" icon="search" inputProps={{ defaultValue: 'With left icon' }} />
      <TextField
      ...
      />
      <TextField label="Prominent input" size="l" icon="search" inputProps={{ defaultValue: 'With left icon' }} />
    </Stack>
  </Box>
</Playground>
